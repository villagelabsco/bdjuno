...
func NewDepositParam(d *v1govtypes.DepositParams) DepositParams {
...
func NewGenesisDepositParam(d *v1beta1govtypes.DepositParams) DepositParams {
	return DepositParams{
		MinDeposit:       d.MinDeposit,
		MaxDepositPeriod: d.MaxDepositPeriod.Nanoseconds(),
	}
...
func NewVotingParams(v *v1govtypes.VotingParams) VotingParams {
	return VotingParams{
...
func NewGenesisVotingParams(v *v1beta1govtypes.VotingParams) VotingParams {
	return VotingParams{
		VotingPeriod: v.VotingPeriod.Nanoseconds(),
	}
}
...
func NewTallyParams(t *v1govtypes.TallyParams) TallyParams {
	return TallyParams{
		Quorum:        t.Quorum,
...
func NewGenesisTallyParams(t *v1beta1govtypes.TallyParams) GenesisTallyParams {
...
type Proposal struct {
	...
	ProposalType    string
	ProposalID      uint64
	Content         v1beta1govtypes.Content
	Status          string
